                        ...
                        <Col md="6" sm="12" xs="12">
                            <Card className="text-center card-item">
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>This is a currency converter written in JavaScript, HTML and CSS.</Card.Text>
                                    <Card.Link href="https://github.com/hharnack/CurrencyConverter">See the Code</Card.Link>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md="6" sm="12" xs="12">
